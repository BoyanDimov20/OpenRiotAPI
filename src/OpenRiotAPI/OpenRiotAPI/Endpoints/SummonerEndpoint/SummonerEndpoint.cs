...
namespace OpenRiotAPI.Endpoints.SummonerEndpoint
{
    internal class SummonerEndpoint : EndpointBase, ISummonerEndpoint
    {
        ...
        private const string SummonerByAccountId = "lol/summoner/v4/summoners/by-account/{0}";
        private const string SummonerBySummonerId = "lol/summoner/v4/summoners/{0}";
        private const string SummonerByPuuid = "lol/summoner/v4/summoners/by-puuid/{0}";
        ...
        {
            var url = RiotUri.CreateUrl(region, SummonerByName, summonerName);
